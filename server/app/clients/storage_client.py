...
class StorageClient:
    ...
    async def get_all_secrets(self) -> List[Dict[str, Any]]:
    ...
    async def create_secret(self, secret_data: Dict[str, Any]) -> Dict[str, Any]:
        """Create a new secret"""
    ...
    async def update_secret(self, secret_id: str, secret_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def get_all_keys(self, key_type: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def get_key_by_id(self, key_id: int) -> Dict[str, Any]:
    ...
    async def get_key_by_type(self, key_type: str) -> Dict[str, Any]:
    ...
    async def create_key(self, key_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def deactivate_key(self, key_id: int) -> Dict[str, Any]:
    ...
    async def get_secrets_for_user(self, user_id: str) -> List[Dict[str, Any]]:
        """Get all secrets and filter by user_id (client-side filtering)"""
        all_secrets = await self.get_all_secrets()
        return [secret for secret in all_secrets if secret.get("user_id") == user_id]
